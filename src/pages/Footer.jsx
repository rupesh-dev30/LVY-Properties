...
const socialIcons = [
  ...
  { icon: <FaGoogle />, href: "#", name: "Google" },
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          <div className="flex items-center gap-4 group">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">Premium Real Estate Solutions</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 group">
              ...
              <div>
                <span className="font-semibold text-amber-300 block">Timings:</span>
                <span className="text-gray-300">Monday to Sunday - 10 AM To 8 PM</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 group">
              ...
              <div>
                <span className="font-semibold text-blue-300 block">Head Office:</span>
                <span className="text-gray-300 text-sm leading-relaxed">
                  213 Second Floor Suncity Arcade Suncity Golf Course Road Sector 54 Gurgaon
                </span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 group">
              ...
              <div>
                <span className="font-semibold text-emerald-300 block">Phone:</span>
                <span className="text-gray-300">+91-9810540670, +91-9654800080</span>
              </div>
            </div>
    ...
    <div className="relative border-t border-white/20 py-6 px-6 bg-black/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex flex-col md:flex-row gap-4 text-gray-300 text-sm">
          ...
          <a href="#" className="hover:text-amber-300 transition-colors duration-300">Cookie Policy</a>
        </div>
        <div className="text-gray-300 text-sm">
          <span className="font-semibold">LVY Properties</span> © 2025. All Rights Reserved.
        </div>
      </div>
    </div>
  </footer>
